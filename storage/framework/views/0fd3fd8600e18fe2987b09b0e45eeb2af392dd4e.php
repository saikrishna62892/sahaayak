    ...
    <div class="card shadow p-4 mb-5 bg-white rounded">
        ...
        <div class="row">
            ...
            <div class="card-body" style="width: 40%;">
                ...
                <br>
                <div class="form-group">
                    <img style="float: right;" src="<?php echo e(\Storage::disk('s3')->url($counsellor->file1)); ?>" width="100" height="100">
                </div>
            </div>
        </div>
            <div align="right">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\G.SAI KRISHNA\Desktop\Sahayak\sahaayak\resources\views/counsellors/getDetails.blade.php ENDPATH**/ ?>