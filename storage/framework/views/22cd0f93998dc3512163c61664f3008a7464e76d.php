...
<?php $__env->stopSection(); ?>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="classes__item">
                        ...
                        <div class="classes__item__text">
                            ...
                            <h6 align="justify" style="overflow: hidden;display: -webkit-box;-webkit-line-clamp: 12;-webkit-box-orient: vertical;white-space: pre-wrap"><?php echo e($item->content); ?></span></h6>
                            <a href="<?php echo e($item->newsurl); ?>" class="btn btn-primary" target="_blank" style="background-color: #5768ad;">Read More</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Classes Section End -->
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\G.SAI KRISHNA\Desktop\Sahayak\sahaayak\resources\views//news/show.blade.php ENDPATH**/ ?>