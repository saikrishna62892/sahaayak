                ...
                <div class="col-lg-4 order-lg-1 order-2">
                    <div class="blog__sidebar">
                        ...
                        <div class="blog__sidebar__categories">
                            ...
                            <ul>
                                <li><a href="#">All</a></li>
                                <li><a href="#">Depression(#count)</a></li>
                                <li><a href="#">Suicide(#count)</a></li>
                                <li><a href="#">Stress(#count)</a></li>
                                <li><a href="#">Stigma(#count)</a></li>
                                <li><a href="#">Depression(#count)</a></li>
                                <li><a href="#">Suicide(#count)</a></li>
                                <li><a href="#">Stress(#count)</a></li>
                                <li><a href="#">Stigma(#count)</a></li>
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    <ul>
                                        <li><i class="fa fa-calendar-o"></i> June 23, 2020</li>
                                        <li><i class="fa fa-heart-o"></i> 5</li>
                                    </ul>
                                    <h5><a href="#">Heading</a></h5>
                                    <p>full matter with character limit</p>
                                    <a href="expert_story.html" class="blog_read_more">READ MORE <span class="arrow_right"></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
...
<?php echo $__env->make('layouts/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\G.SAI KRISHNA\Desktop\sahaayak\resources\views/talks.blade.php ENDPATH**/ ?>