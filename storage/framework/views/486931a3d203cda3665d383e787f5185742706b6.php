                                                            ...
                                                            <div class="card-body">
                                                                <div class="blog__details__large">
                                                                    <?php if(is_null($talk->image)): ?>
                                                                        <img src="<?php echo e(asset('/img/talks/default1.jpg')); ?>" alt="" width="700" height="350">
                                                                    <?php else: ?>
                                                                        <img src="<?php echo e(\Storage::disk('s3')->url('uploads/talk/img/'.$talk->image)); ?>" alt="" width="700" height="350">
                                                                    <?php endif; ?>
                                                                ...
                                                                <div class="blog__details__text blog__item__text">
                                                                    ...
                                                                    <p align="justify" style="white-space: pre-wrap"><?php echo e($talk->content); ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\G.SAI KRISHNA\Desktop\Sahayak\sahaayak\resources\views//talks/show.blade.php ENDPATH**/ ?>