...
<!-- Blog Details Section Begin -->
                    ...
                    <div class="blog__details">
                        <div class="blog__details__author">
                            <div class="blog__details__author__pic">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(\Storage::disk('s3')->url('uploads/quote/img/'.$quote->Image)); ?>" alt="">
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="blog__details__quote">
                            <p align="justify" style="font-size: 25px;font-weight: bold;font-style: italic;font-family: Futura;"><i class="fa fa-quote-left" aria-hidden="true"></i>&nbsp;<?php echo e($quote->Quote); ?>&nbsp;<i class="fa fa-quote-right" aria-hidden="true"></i></p>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ganesh\Desktop\dileep\sahaayak\resources\views/inspire_me.blade.php ENDPATH**/ ?>