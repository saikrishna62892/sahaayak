...
<!-- Blog Details Section Begin -->
                    ...
                    <div class="blog__details">
                        <div class="blog__details__author">
                            ...
                            <?php if(is_null($i->image)): ?>
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(\Storage::disk('s3')->url('uploads/playlist/img/'.$i->image)); ?>" alt="" width="500" height="250">
                                <?php endif; ?>
                            </div>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Sahaayak\sahaayak\resources\views/playlists.blade.php ENDPATH**/ ?>