            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__text">
                        <h2>Understanding Loss of Fear</h2>
                        <h5>Quote about Loss of Fearn</h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="classes__details">
                        <div class="classes__details__large">
                            ...
                            <span>Understanding Loss of Fear</span>
                        </div>
                        <h2>What is Loss of Fear?</h2>
...
<?php echo $__env->make('layouts/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\G.SAI KRISHNA\Desktop\sahaayak\resources\views/learn_fear_of_loss.blade.php ENDPATH**/ ?>