			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-45 p-b-30">
				<form class="login100-form validate-form" method="post" action="/register/step2/<?php echo e($user->id); ?>" enctype="multipart/form-data">
					...
					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Full Name"  autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="tel" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="Phone"  autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="text" name="qualification" value="<?php echo e(old('qualification')); ?>" placeholder="Qualification"  autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="text" name="work" value="<?php echo e(old('work')); ?>" placeholder="Working in"  autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="text" name="insight" value="<?php echo e(old('insight')); ?>" placeholder="Insight"  autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="text" name="queries" value="<?php echo e(old('queries')); ?>"placeholder="Queries" autocomplete="off" >
...
unset($__errorArgs, $__bag); ?>
	...
	<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.reg_forms_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\G.SAI KRISHNA\Desktop\Sahayak\sahaayak\resources\views/volunteer/volunteer_signup.blade.php ENDPATH**/ ?>