                                                        ...
                                                        <?php $count++; ?>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="blog__details__text blog__item__text">
                                                                    ...
                                                                    <h6>Post your stories anonymously <a href="<?php echo e(route('register')); ?>" style="color: #5768ad;">Register here.</a></h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\G.SAI KRISHNA\Desktop\Sahayak\sahaayak\resources\views//stories/show.blade.php ENDPATH**/ ?>