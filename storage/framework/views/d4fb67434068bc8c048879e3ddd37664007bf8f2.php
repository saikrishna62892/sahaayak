	...
	<div class="row">
		<div class="card col-lg-12 col-md-6 shadow p-4 mb-5 bg-white rounded" style="background-color: #f5f6fa;">
		  <div class="card-body">
		    ...
		    <a href="<?php echo e(url('displayStories')); ?>" class="card-link" style="color: #5768ad;">See Post</a>
		  </div>
		</div>
	</div>
	<br>
...
</div><?php /**PATH C:\Users\G.SAI KRISHNA\Desktop\Sahayak\sahaayak\resources\views/stories/shared_stories.blade.php ENDPATH**/ ?>